...
.method public static read(Ljava/io/File;)Lokhttp3/internal/cache2/Relay;
    ...
    invoke-virtual {v1, v3, v4}, Lokio/Buffer;->readByteString(J)Lokio/ByteString;
    ...
    invoke-virtual {v12, v3}, Lokio/ByteString;->equals(Ljava/lang/Object;)Z
    ...
    new-instance v18, Lokhttp3/internal/cache2/Relay;
    ...
    .line 161
    .end local v9    # "metadataBuffer":Lokio/Buffer;
    .local v21, "metadataBuffer":Lokio/Buffer;
    invoke-direct/range {v3 .. v10}, Lokhttp3/internal/cache2/Relay;-><init>(Ljava/io/RandomAccessFile;Lokio/Source;JLokio/ByteString;J)V
...
.method private writeMetadata(J)V
    ...
    iget-object v2, p0, Lokhttp3/internal/cache2/Relay;->metadata:Lokio/ByteString;
